...
require_once("include/academic_specializations_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "public.academic_specializations" );
