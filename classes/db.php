	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "financialslatestDbatlocalhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "usc_rapid_users", "varname" => "financialslatestDbatlocalhost_public_usc_rapid_users", "altvarname" => "usc_rapid_users", "connId" => "financialslatestDbatlocalhost", "schema" => "public", "connName" => "financialslatestDb at localhos");
		}
	}
